 ...
 * Description:
 */
public class FolderView extends RelativeLayout implements CanMergeView {
    ...
    private static final int FOLDER_ID = R.id.folder_bg;
    private static final int TAG_ID = R.id.folder_tag;
    private static final int CONTAINER_GRID_ID = R.id.folder_grid_layout;
    private static final int CHECK_BOX_ID = R.id.folder_check_box;
    private static final int CONTENT_ID = R.id.folder_content;

    private PrimitiveSimpleAdapter mSimpleAdapter;
    private FolderGridLayout mGridLayout;
    ...
    public FolderView(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
    ...
    private void ensureViewFound() {
        if (mFolderBg == null | mContent == null | mTagView == null | mGridLayout == null) {
            ...
            mGridLayout = (FolderGridLayout) findViewById(CONTAINER_GRID_ID);
