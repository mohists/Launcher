...
public class FolderGridLayout extends ViewGroup {
    ...
    public FolderGridLayout(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public FolderGridLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.FolderGridLayout, defStyleAttr, 0);
        mRowCount = a.getInt(R.styleable.FolderGridLayout_folderRowCount, 2);
        mColumnCount = a.getInt(R.styleable.FolderGridLayout_folderColumnCount, 2);
        mGap = a.getDimensionPixelSize(R.styleable.FolderGridLayout_folderGap, 0);
        a.recycle();
    }
